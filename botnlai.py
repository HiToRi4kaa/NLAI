...
bot = telebot.TeleBot('8064955635:AAHDznfYY5TJAb4VLLYbM-f_SHlsGAtoePk')
...
def send_info(message):
    ...
    bot.send_message(
        ...
        "👨‍🎓 <b>Автор:</b> студент <i>Новокаховського політехнічного фахового коледжу Національного університету «Одеська політехніка»</i>\n"
        "📚 <b>Група:</b> 12221\n"
...
def handle_playlist_menu(call):
    ...
    bot.edit_message_text(
        ...
        text="📄 <b>Меню плейлистів:</b>\n\n"
             ...
             "✏️Редагувати плейлисти – редагування існуючих плейлистів.\n\n"
        reply_markup=markup,
        parse_mode='HTML'
    )
