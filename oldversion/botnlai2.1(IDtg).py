...
def handle_music_option(call):
    ...
    Відображає список доступної музики для вибору та прослуховування.
    ...
    bot.send_audio(chat_id, current_track_id)
    ...
    bot.send_message(chat_id, "🎵 Відтворення музики:", reply_markup=markup)
