...
def handle_view_playlists(call):
    ...
    markup = telebot.types.InlineKeyboardMarkup()
    for playlist_name in user_playlists:
        callback_data = generate_safe_callback_data('manage_playlist', playlist_name)
        playlist_button = telebot.types.InlineKeyboardButton(playlist_name, callback_data=callback_data)
